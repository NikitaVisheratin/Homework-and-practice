//Написать односвязный список и его функционал + расширить до двусвязного.
#include <iostream>
...
struct Node
{
	...
	Node(int _value) : value(_value), nextPtr(nullptr), prevPtr(nullptr) {} //Конструктор
};
